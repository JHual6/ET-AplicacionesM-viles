  ...
  export class AsignaturaPage implements OnInit {
    ...
    async verificarQR() {
      ...
      console.log('Código QR escaneado (this.qrCodeData):', this.qrCodeData);
      console.log('Texto del QR de la clase (textoCodigoQrClase):', textoCodigoQrClase);

      // Compara los códigos QR
      if (this.qrCodeData === textoCodigoQrClase && this.id_clases) {
        ...
        await this.showErrorAlert('El código QR no es válido para esta clase.');
      }
    }
